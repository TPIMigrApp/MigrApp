...
<html>
	...
	<body>
		<a href="#edit-foto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-foto" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:fotoInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
